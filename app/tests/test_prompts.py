...
async def test_create_prompt(client: AsyncClient, session: AsyncSession, monkeypatch):
    ...
    monkeypatch.setattr(openai.ChatCompletion, "create", mock_completion_create)
